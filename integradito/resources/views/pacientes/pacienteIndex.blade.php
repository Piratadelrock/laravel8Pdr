...
<div class="container mx-auto p-4">
    ...
    <button onclick="window.location.href='{{ route('pacientes.create') }}'" 
        ...
        <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow-md ">
            <thead class="bg-gray-200">
                <tr>
                    ...
                    <th class="px-4 py-2 text-left font-semibold text-gray-700">Fecha de Nacimiento</th>
                    <th class="px-4 py-2 text-left font-semibold text-gray-700">Numero de documento</th>
            ...
            <tbody>
                @foreach ($pacientes as $paciente)
                    <tr class="border-b hover:bg-gray-100">
                        <td class="px-4 py-2 text-gray-800">{{ $paciente->id }}</td>
                        <td class="px-4 py-2 text-gray-800">{{ $paciente->nombre }}</td>
                        <td class="px-4 py-2 text-gray-800">{{ $paciente->fecha_nacimiento }}</td>
                        <td class="px-4 py-2 text-gray-800">{{ $paciente->documento_identidad }}</td>
                        ...
                        <td class="px-4 py-2">
                            ...
                            <a href="{{ route('pacientes.edit', $paciente->id) }}" class="bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-600">Editar</a>
